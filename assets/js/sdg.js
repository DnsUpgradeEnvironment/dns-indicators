...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, precisionItems, decimalSeparator, dataSchema, viewHelpers, modelHelpers, chartTitles) {
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"min_zoom":4.5,"max_zoom":7.5,"staticBorders":true,"subfolder":"boundaries","label":"indicator.map"},{"min_zoom":8,"max_zoom":11,"staticBorders":false,"subfolder":"boundariesKrs","label":"??"}],
      precision: precision,
