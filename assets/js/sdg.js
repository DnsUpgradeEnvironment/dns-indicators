...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, precisionItems, decimalSeparator, dataSchema, viewHelpers, modelHelpers, chartTitles) {
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"serviceUrl":"https://dnsupgradeenvironment.github.io/dns-indicators/assents/maps/boundaries.geojson","min_zoom":4.5,"max_zoom":7.5,"staticBorders":true,"subfolder":"boundaries","label":"indicator.map"},{"serviceUrl":"https://dnsupgradeenvironment.github.io/dns-indicators/assents/maps/boundariesKrs.geojson","min_zoom":8,"max_zoom":11,"staticBorders":false,"subfolder":"boundariesKrs","label":"indicator.map"}],
      precision: precision,
